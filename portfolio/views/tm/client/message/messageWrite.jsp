...
<jsp:include page="/WEB-INF/views/include/header.jsp" />
	...
	<div class="wrapAll client">
		...
		<div class="msWrap">
			...
			<form action="/portfolio/msg/messageWritePro.pf" name="messageWrite" onsubmit="return check()" method="get">
			<div class="msWrite"> 
			...
			<div class="btnWrap">
				...
				<p onclick="window.location='/portfolio/msg/message.pf'" class="btn btnC">취소</p>
			</div>
			</form>

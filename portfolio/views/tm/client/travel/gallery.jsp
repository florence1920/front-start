...
<jsp:include page="/WEB-INF/views/include/header.jsp" />
	...
	<div class="wrapAll client">
		...
		<script>
			...
			*/
				$('.liked').submit(function(event){
					...
					console.log("좋아요호출");
					$.ajax({
						url: "/portfolio/travel/galleryLiked.pf",
						cache: false,	//재호출을 위함
						type: "POST",
						dataType: "json",
				...
				$('.likedCancel').submit(function(event){
					...
					console.log("취소호출");
					$.ajax({
						url: "/portfolio/travel/galleryLikedCancel.pf",
						cache: false,	//재호출을 위함
						type: "POST",
						dataType: "json",
						contentType: "application/json",
		...
		<div class="gsWrap">
         ...
         <ul class="gsMenu">
            <li><a href="groupSpace.pf?gNo=${grp.gNo}">그룹홈</a></li>
            <li class="on"><a href="gallery.pf?gNo=${grp.gNo}">갤러리${gNo}</a></li>
         </ul>
         ...
         <div class="gsCont gsGal">
            ...
            <form action="/portfolio/travel/uploadPro.pf" method="post" enctype="multipart/form-data">
						...
						<li>
							<c:if test="${list.isLiked==1}">
								<form class="likedCancel" method="post">
									...
									<img src="/portfolio/save/${list.pRoot}" width="500"/>
									<br/>

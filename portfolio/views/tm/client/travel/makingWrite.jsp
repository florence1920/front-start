...
<jsp:include page="/WEB-INF/views/include/header.jsp" />
	...
	<div class="wrapAll client">
		...
		<div class="makingContWrap">
			...
			<form action="/portfolio/travel/makingWritePro.pf" name="inputForm" onsubmit="return validation()" method="post">
				...
				<div class="btnWrap">
					...
					<a href="/portfolio/travel/makingList.pf"><p class="btn btnC">취소</p></a>
				</div>
			</form>
		</div>
		<!-- makingContWrap end -->

...
<jsp:include page="/WEB-INF/views/include/header.jsp" />
	...
	<div class="wrapAll client">
		...
		<form action="/portfolio/travel/makingReqPro.pf" name="inputForm" onsubmit="return validation()" method="post">
		...
		<div class="btnWrap">
			...
			<a href="/portfolio/travel/makingList.pf"><p class="btn btnC">리스트</p></a>
		</div>

	...
	<div id="transcroller-body" class="wrapAll client">
		...
		<div class="makingListWrap">
			...
			<div class="titWrap">
				...
				<div class="goMake">
					<a href="/portfolio/travel/makingWrite.pf"></a>
			...
			<div class="myMake">
				...
				<ul class="list">
					...
					<li>
						<a href="makingCont.pf?gNo=${wArticle.gNo}"></a>
				...
				<ul class="list">
					...
					<li>
						<a href="groupSpace.pf?gNo=${jArticle.gNo}"></a>
			...
			<div class="searchMake">
				<div class="inner">
					<!-- 검색창 -->
					<form id="searchForm" name="searchForm" onsubmit="return validation()" method="post" action="makingList.pf">			
				...
				<div id="list">
					<div id="articleTable">				
						<ul class="makingList">
							...
							<li>
								<a href="makingCont.pf?gNo=${article.gNo}&pageNum=${pageNum}"></a>
				...
				<div class="pageNumbers">
					...
					<c:if test="${startD!=null && endD!=null}">
						<c:if test="${startPage>pageBlock}">
							<a href="makingList.pf?pageNum=${startPage-pageBlock}&startD=${startD}&endD=${endD}"> &lt; </a>
						</c:if>				
					</c:if>				
					<c:if test="${startD==null || endD==null}">
						<c:if test="${startPage>pageBlock}">
							<a href="makingList.pf?pageNum=${startPage-pageBlock}"> &lt; </a>
						</c:if>
					</c:if>
					<!-- 페이지번호 리스트 -->				
					<c:if test="${startD!=null && endD!=null}">
						<c:forEach var="i" begin="${startPage}" end="${endPage}" step="1">
							<a href="makingList.pf?pageNum=${i}&startD=${startD}&endD=${endD}">&nbsp; ${i} &nbsp;</a>
						</c:forEach>
					</c:if>
					<c:if test="${startD==null || endD==null}">
						<c:forEach var="i" begin="${startPage}" end="${endPage}" step="1">
							<a href="makingList.pf?pageNum=${i}">&nbsp; ${i} &nbsp;</a>
						</c:forEach>
					</c:if>
					<!-- 뒤로 가는 기호 -->				
					<c:if test="${startD!=null && endD!=null}">

...
<jsp:include page="/WEB-INF/views/include/header.jsp" />
	...
	<div class="wrapAll client">
		...
		<form action="/portfolio/land/landWritePro.pf" name="inputForm" onsubmit="return validation()" method="post">
			...
			<%-- <table>
				...
				<tr>
					<td colspan="2">
						...
						<input type="button" value="취소" onclick="window.location='/portfolio/client/landmark/landmark.pf'"/>
					</td>
			</table> --%>
		...
		<div class="btnWrap">
			...
			<p class="btn btnC" onclick="window.location='/portfolio/client/landmark/landmark.pf'">취소</p>
		</div>
		</form>

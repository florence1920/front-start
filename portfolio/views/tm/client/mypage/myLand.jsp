...
<div class="myPageWrap">
	...
	<script>
		...
		//	*** 좋아요한 랜드마크 ***
			...
			$.ajax({
				type: "POST",
				url: "/portfolio/land/myLikedLand.pf",
				dataType: "json",
			...
			function likedMarkers() {				
				...
				for (var i=0; i<positions.length; i++) {
					...
					kakao.maps.event.addListener(marker, 'click', function(mouseEvent) {
						...
						$.ajax({
							url: "/portfolio/land/landmarkCont.pf",
							type: "POST",
							dataType: "json",
		...
		//	*** 작성한 랜드마크 ***
			...
			$.ajax({
				type: "POST",
				url: "/portfolio/land/myWrittenLand.pf",
				dataType: "json",
	...
	<div class="btnMyWrap">
		<button onclick="window.location='/portfolio/land/landWrite.pf'" class="btnY">랜드마크 생성</button>
	</div>
	<div class="myLandCont">
		...
		<div class="Cont">
			...
			<c:if test="${fn:length(lLand)>0}">
				...
				<form action="/portfolio/land/likedLandCancel.pf" name="cancelfrm" method="post" onsubmit="return cancelCheck()">
			...
			<c:if test="${fn:length(wLand)>0}">
				...
				<form action="/portfolio/land/myLandDelete.pf" name="removefrm" method="post" onsubmit="return removeCheck()">

   ...
   <!-- //top end -->
	...
	$(document).ready(function () {
		$('#group').change(function () {
			...
			$.ajax({
				type : "get",
				url : "/portfolio/cmt/selectTravel.pf",   //요청할 컨트롤러
				dataType : "json",
	...
	<h2 class="pageTit" data-aos="fade-right" data-aos-duration="600">
      ...
      <img src="/portfolio/resources/images/tm/myhomeimg.png"></img>
	...
	<div id="cont1">
		<c:if test="${count == 0}">
			...
			<button onclick="window.location='/portfolio/travel/makingList.pf'">여행떠나기</button>
		</c:if>
		<c:if test="${count >0}">
			<c:if test="${empty cmtMyGroup}">
      ...
      <!-- //cont1 end  -->   
	<div id="cont2">
		<form action="/portfolio/cmt/commentWritePro.pf" class="cWrite" name="commentWrite" onsubmit="return check()" method="get">

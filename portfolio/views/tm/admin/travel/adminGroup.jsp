...
<jsp:include page="/WEB-INF/views/include/header.jsp" />
	...
	<div class="wrapAll admin">
		...
		<%-- <div class="searchBar">
			<form action="/portfolio/admin/adminGroup.pf">
				<select name="sel">
			...
			<c:if test="${sel != null && search != null }">
				<button onclick="window.location='/portfolio/admin/adminGroup.pf'">전체목록</button>
			</c:if>
		</div> --%>
		<!-- //searchBar end -->
		...
		<ul class="adminGroup">
			...
			<li>
				<button onclick="window.location='/portfolio/admin/adminGroupDel.pf?gNo=${groupAllList.gNo}'">그룹삭제</button>
				<a href="/portfolio/travel/makingCont.pf?gNo=${groupAllList.gNo}&id=${memId}">
				<p>No.${status.count}</p>
			...
			<li>
				<a href="/portfolio/travel/makingCont.pf?gNo=${searchGroupList.gNo}">
				<p>No.${status.count}</p>
